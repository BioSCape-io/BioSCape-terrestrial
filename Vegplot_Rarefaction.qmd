...
S_{\text{obs}} = \frac{S_{\text{max}} \cdot \text{effort}}{K + \text{effort}}

S_n ~ Number of species observed after n units of sampling
Smax ~ Total number of species in the pool
K ~ Sampling effort needed to detect 50% of those species
